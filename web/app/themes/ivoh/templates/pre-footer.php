  ...
  <div class="fb-container-md grid">
    ...
    <div id="support-us" class="-item md-one-half accordion expanded-md">
      ...
      <div class="accordion-content">      
        <p>Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Maecenas faucibus mollis interdum. Maecenas sed diam eget risus varius blandit sit amet.</p>
        <p class="action"><a href="#" class="button">Donate</a></p>
      </div>
    </div>
